...
def drawUnitProgressBar(self, time, task):
    ...
    try:
        ...
        self.yellow_progress_path = LineNodePath(parent = self.point_path, thickness = 8.0, colorVec = Vec4(1.0,1.0,0,0.5))
        ...
        self.purple_progress_path = LineNodePath(parent = self.point_path, thickness = 8.0, colorVec = Vec4(0.5,0,1.0,0.5))
