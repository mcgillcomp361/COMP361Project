...
AI_ACTIVATE_PLANET_WAIT_TIME = 50
AI_ACCELERATION_TIME = 3
AI_START_CONSTRUCTION_WAIT_TIME = 5
AI_UNIT_CONSTRUCTION_WAIT_TIME = 3
AI_MAX_NUMBER_OF_UNITS = 4 #per planet(should not be less than 3)
...
GENERATOR_CORE_RESOURCE_GENERATION_RATE = 9
...
HORDE_MAX_ENERGY = 400
HORDE_DAMAGE = 15
HORDE_COOL_DOWN_TIME = 1
HORDE_VELOCITY = 1
HORDE_BUILD_TIME = 18
...
HIVE_MAX_ENERGY = 1000
HIVE_DAMAGE = 35
HIVE_COOL_DOWN_TIME = 1
HIVE_VELOCITY = 1
HIVE_BUILD_TIME = 36
...
SPHERE_MAX_ENERGY = 640
SPHERE_DAMAGE = 30
SPHERE_COOL_DOWN_TIME = 3
SPHERE_VELOCITY = 1
SPHERE_BUILD_TIME = 28
...
PLANETARIUM_MAX_ENERGY = 1440
PLANETARIUM_DAMAGE = 100
PLANETARIUM_COOL_DOWN_TIME = 4
PLANETARIUM_VELOCITY = 1
PLANETARIUM_BUILD_TIME = 50
...
ANALYZER_MAX_ENERGY = 200
ANALYZER_DAMAGE = 0
ANALYZER_COOL_DOWN_TIME = 5
ANALYZER_VELOCITY = 1
ANALYZER_BUILD_TIME = 10
...
MATHEMATICA_MAX_ENERGY = 720
MATHEMATICA_DAMAGE = 0
MATHEMATICA_COOL_DOWN_TIME = 1
MATHEMATICA_VELOCITY = 1
MATHEMATICA_BUILD_TIME = 30
