...
'''
''' Environment '''
UNIVERSE_SCALE = 10000

''' Stars '''
STAR_BUILD_TIME = 0
MAX_DEAD_STAR_RADIUS = 5
MAX_STAR_RAIDUS = 20
...
MAX_DEAD_PLANET_RADIUS = 6
MAX_PLANET_RADIUS = 12
DISTANCE_BETWEEN_PLANETS = MAX_PLANET_RADIUS*2.5
MIN_PLANET_VELOCITY = 50
MAX_PLANET_VELOCITY = 150

''' Deep Space '''
DEEP_SPACE_DISTANCE = DISTANCE_BETWEEN_PLANETS*MAX_NUMBER_OF_PLANETS
